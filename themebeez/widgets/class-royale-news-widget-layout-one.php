<?php
/**
 * Widget class definition for RN: News Layout One.
 *
 * @since 1.0.0
 *
 * @package Royale_News
...
if ( ! class_exists( 'Royale_News_Widget_Layout_One' ) ) {
	/**
	 * Widget class - Royale_News_Widget_Layout_One.
	 *
	 * @since 1.0.0
	 *
	 * @package Royale_News
	...
	class Royale_News_Widget_Layout_One extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'royale-news-news-layout-widget-one',
				esc_html__( 'RN: News Layout One', 'royale-news' ),
				array(
